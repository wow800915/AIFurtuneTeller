...
class PhotoReasoningViewModel: ObservableObject {
    ...
    func reason() async {
        await generateOutput(prompt: "繁體中文回答，請根據這張照片中的人，專注於具體的外貌細節，如髮型、膚質、眼神或微笑，生成一段充滿正能量的誇讚語句，同時也可以帶入未來的美好可能性。例如，可以提到他可能在職場上有所成就，或是擁有幸福的家庭。語氣需溫暖且真誠，讓人感到愉快和自信。請避免過於籠統，注重具體細節，例如：「你的笑容像陽光一樣溫暖，未來你一定會成為一個帶給大家正能量的領導者。」或「你的眼神充滿希望，讓人相信你未來會擁有無限的可能性！」")
    }
